    ...
    return (
        <div className="background-container">
            ...
            <section className="hero-section" id="home">
                <div className="logo">
                    <img src="fctc.png" alt="FCTC TOKEN Logo" />
                </div>
            ...
            <section className="section" id="about">
                ...
                <div className="image-container">
                    <img src="Gemini_Generated_Image_2jrb6z2jrb6z2jrb.jpeg" alt="Blockchain GIF" className="small" />
                    <img src="Gemini_Generated_Image_2jrb6y2jrb6y2jrb.jpeg" alt="Additional Image 1" />
                    <img src="Gemini_Generated_Image_2jrb702jrb702jrb.jpeg" alt="Additional Image 2" />
                </div>
            </section>
            ...
            <section className="section" id="mission">
                ...
                <img src="m.jpeg" alt="Mission GIF" />
            </section>
